...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.newPage = QtGui.QPushButton(self.frame_4)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(os.path.dirname(__file__) + "/icons/app.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.newPage.setIcon(icon2)
        self.newPage.setIconSize(QtCore.QSize(64, 64))
        self.newPage.setFlat(True)
        self.newPage.setObjectName("newPage")
        self.horizontalLayout_4.addWidget(self.newPage)
...
"    background:white;", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.newPage.setText(QtGui.QApplication.translate("MainWindow", "Create New Page", None, QtGui.QApplication.UnicodeUTF8))
