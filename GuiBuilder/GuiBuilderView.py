...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(os.path.dirname(__file__) + QtGui.QPixmap("/icons/filesave.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.rearrange.setObjectName(os.path.dirname(__file__) + "/rearrange")
